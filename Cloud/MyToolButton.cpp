...
void MyToolButton::painterinfo(int topPartOpacity, int bottomPartOpacity, QPainter *painter)
{
    ...
    linear.setColorAt(0, QColor(157, 255, 237, topPartOpacity));
    linear.setColorAt(0.5, QColor(157, 255, 237, 255));
    linear.setColorAt(1, QColor(157, 255, 237, bottomPartOpacity));
