...
#include "../../Cloud/MyMenuBar/MyToolButton.h"
...
QT_MOC_LITERAL(1, 13, 12), // "SignalParent"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13), // "MyToolButton*"
QT_MOC_LITERAL(4, 41, 11) // "SlotPressed"

    },
    "MyToolButton\0SignalParent\0\0MyToolButton*\0"
    "SlotPressed"
};
...
void MyToolButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SignalParent((*reinterpret_cast< MyToolButton*(*)>(_a[1]))); break;
        ...
        {
            typedef void (MyToolButton::*_t)(MyToolButton * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyToolButton::SignalParent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyToolButton::SignalParent(MyToolButton * _t1)
{
